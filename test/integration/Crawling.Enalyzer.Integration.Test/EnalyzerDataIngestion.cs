...
{
    public class DataIngestion : IClassFixture<EnalyzerTestFixture>
    {
        private readonly EnalyzerTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(EnalyzerTestFixture fixture, ITestOutputHelper output)
        {
