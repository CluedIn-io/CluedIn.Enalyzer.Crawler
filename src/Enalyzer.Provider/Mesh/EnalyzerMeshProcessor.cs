...
{
    public class Enalyzer_Command_MeshProcessor : BaseMeshProcessor
    {
        public Enalyzer_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          EnalyzerConstants.ProviderId;
